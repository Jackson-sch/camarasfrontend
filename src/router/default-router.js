...
import Registro from "../views/dashboard/incidencias/registro";
import Listar from "../views/dashboard/incidencias/listar";
import Papelera from "../views/dashboard/incidencias/papelera/papelera"
    ...
    <TransitionGroup>
      <CSSTransition classNames="fadein" timeout={300}>
        <Switch>
          ...
          {/* registro incidencias */}
          <Route path="/dashboard/maps/registro" exact component={Registro} />
          <Route path="/dashboard/maps/listar" exact component={Listar} />
          <Route path="/dashboard/maps/papelera/papelera" exact component={Papelera} />
        </Switch>
      </CSSTransition>
    </TransitionGroup>
  );
