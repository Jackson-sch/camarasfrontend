                ...
                <Card className="card-transparent shadow-none d-flex justify-content-center mb-0 auth-card">
                  <Card.Body>
                    ...
                    >
                      ...
                      <h4 className="logo-title ms-3">Jackson Sebastian</h4>
                    </Link>
                    <h2 className="mb-2 text-center">Registrarse</h2>
                    <p className="text-center">Inicie sesión para mantenerse conectado.</p>
                    <Form>
                      <Row>
                        <Col lg="12">
                        ...
                        <Col lg="12" className="d-flex justify-content-between">
                          ...
                          <Link to="/auth/recoverpw">¿Has olvidado tu contraseña?</Link>
                        </Col>
                      </Row>
                      ...
                      o iniciar sesión con otras cuentas?
                      </p>
                      <div className="d-flex justify-content-center">
                        <ListGroup
                          as="ul"
