                    ...
                    <Card>
                        <Card.Header className="d-flex justify-content-between flex-wrap">
                            ...
                            <div>
                                ...
                                <Modal show={show} onHide={handleClose}>
                                    ...
                                    <Modal.Title>Agregar Nuevo Permiso</Modal.Title>
                                    </Modal.Header>
                                    <Modal.Body>
                                        <Form.Group className="mb-3" controlId="formBasicPassword">
                                            <Form.Label>Título de Permiso</Form.Label>
                                ...
                                <Modal show={show1} onHide={handleClose1}>
                                    <Modal.Header closeButton>
                                    <Modal.Title>Agregar un nuevo rol</Modal.Title>
                                    </Modal.Header>
                                    <Modal.Body>
                                        <Form.Group className="mb-3" controlId="formBasicPassword">
                                            <Form.Label>Título de Roles</Form.Label>
                                        ...
                                        <Form.Check>
                                            ...
                                            <Form.Check.Label htmlFor="automatically" className="pl-2">Si</Form.Check.Label>
                                        </Form.Check>
                                ...
                                <Modal show={show2}  onHide={handleClose2}>
                                    ...
                                    <Form.Group className="mb-3" controlId="formBasicPassword">
                                                ...
                                                <Form.Control type="text" defaultValue={editname}  onChange={e => setName(e.target.value)} placeholder="Título de permiso" />
                                        </Form.Group>
                                        <div>
                        ...
                        <Card.Body>
                            <div className="table-responsive">
                                ...
                                <Button onClick={() => history.push('/dashboard/admin/admin')} type="button" variant="primary">Guardar</Button>
                                </div>
                            </div>
                        </Card.Body>
                    </Card>
