      ...
      <Accordion as="ul" className="navbar-nav iq-main-menu">
        ...
        >
          ...
          >
            ...
            <span className="item-name">Incidencias</span>
            <i className="right-icon">
              <svg
                xmlns="http://www.w3.org/2000/svg"
                width="18"
          ...
          <Accordion.Collapse eventKey="sidebar-incidencia">
            <ul className="sub-nav">
              <li className="nav-item">
                <Link
                  className={`${
                    location.pathname === "/dashboard/maps/registro" ? "active" : ""
                  } nav-link`}
                  to="/dashboard/maps/registro"
                >
                  <i className="icon">
                    <svg
                      xmlns="http://www.w3.org/2000/svg"
                  ...
                  <span className="item-name"> Registro </span>
                </Link>
              </li>
              <li className="nav-item">
                <Link className="nav-link " to="/dashboard/maps/listar">
                  <i className="icon">
                    <svg
                      xmlns="http://www.w3.org/2000/svg"
                      width="10"
                  ...
                  <span className="item-name">Listar</span>
                </Link>
              </li>
              <li className="nav-item">
                <Link
