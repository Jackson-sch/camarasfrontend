...
import logoMuni1 from '../../../../assets/images/muni/01.png'
    ...
    return (
        <>
            <div className="iq-navbar-header" style={{height: "215px"}}>
                <Container fluid className=" iq-container" style={{paddingTop: "1.5rem"}}>
                    <Row>
                        <Col xs="12" md="4">
                          <div className="d-md-flex justify-content-between flex-wrap">
                            <div>
                              <img src={logoMuni1} class="img-fluid" alt="logoMuni1" />
                            </div>
                          </div>
                        </Col>
                        <Col xs="12" md="4">
